...
## [0.0.x](https://github.com/oras-project/oras-py/tree/main) (0.0.x)
 - make `username` and `password` optional in `login()` so the interactive prompts can be used, closes issue [235](https://github.com/oras-project/oras-py/issues/235) (0.2.44)
